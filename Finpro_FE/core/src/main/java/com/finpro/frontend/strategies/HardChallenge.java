...
public class HardChallenge implements ChallengeGame {
    ...
    public HardChallenge(ChallengeObjectManager objectManager) {
        this.objectManager = objectManager;
        ingredientTexture = new Texture("dating/chris_one_painting.png");
        badIngredientTexture = new Texture("dating/chris_two_painting.png");
